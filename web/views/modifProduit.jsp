<%-- 
    ...
    Created on : Apr 20, 2021, 12:26:03 AM
    Author     : saad
--%>
...
<html>
    ...
    <body>
        ...
        <h2><u><%=request.getAttribute("msg")%></u></h2>
                <%}%>
                <%
                    ...
                    <div class="row">
                        <div class="col-md-4 col-lg-3 col-xl-3 leftColumn aside">
                            ...
                            <div class="tt-collapse open">
                                ...
                                <div class="tt-collapse-content">
                                    <div class="tt-aside">
                                        <a class="tt-item" href="/Store/views/product.jsp">
                                            <div class="tt-img">
                                                <span class="tt-img-default"><img src="/Store/images/loader.svg" data-src="/Store/images/product/product-01.jpg" alt=""></span>
                                                <span class="tt-img-roll-over"><img src="/Store/images/loader.svg" data-src="/Store/images/product/product-01-02.jpg" alt=""></span>
                                            </div>
                                        ...
                                        <a class="tt-item" href="/Store/views/product.jsp">
                                            <div class="tt-img">
                                                <span class="tt-img-default"><img src="/Store/images/loader.svg" data-src="/Store/images/product/product-02.jpg" alt=""></span>
                                                <span class="tt-img-roll-over"><img src="/Store/images/loader.svg" data-src="/Store/images/product/product-02-02.jpg" alt=""></span>
                                            </div>
                                            <div class="tt-content">
                                                <h6 class="tt-title">Flared Shift Dress</h6>
                                                <div class="tt-price">
                                        ...
                                        <a class="tt-item" href="/Store/views/product.jsp">
                                            <div class="tt-img">
                                                <span class="tt-img-default"><img src="/Store/images/loader.svg" data-src="/Store/images/product/product-03.jpg" alt=""></span>
                                                <span class="tt-img-roll-over"><img src="/Store/images/loader.svg" data-src="/Store/images/product/product-03-02.jpg" alt=""></span>
                                            </div>
                                            <div class="tt-content">
                                                <h6 class="tt-title">Flared Shift Dress</h6>
                                                <div class="tt-price">
                                    ...
                                    <div class="col-6 col-md-4 tt-col-item">
                                        <div class="tt-product thumbprod-center">
                                            ...
                                            <div class="tt-description">
                                                ...
                                                <a href="/Store/views/formModifProduit.jsp?idp=<%=p.getIdp()%>" class="tt-btn-addtocart thumbprod-button-bg" >Update Product</a>
