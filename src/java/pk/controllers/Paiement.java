...
import pk.dao.ws.PaiementWS;
import pk.models.Adresse;
import pk.models.Client;
import pk.models.Commande;
import pk.models.Expedition;
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
       ...
       long nocarte=Long.parseLong(request.getParameter("nocarte"));
        ...
        if(PaiementWS.payerCommande(nocarte, datecarte, crypto, mnt).startsWith("ok")){
            ...
            Commande cmd=new Commande(0, clt, ad, new Date(), "VISA", "en cours", null, new ArrayList<Lignecommande>(),null);
            ...
            request.setAttribute("msg", "votre commande est pays avec succes et sera expedier prochainement! ");
            request.getRequestDispatcher("/views/mescommandes.jsp").forward(request, response);
        }else{
            request.setAttribute("msg", "information de paiment incorrecte!");
